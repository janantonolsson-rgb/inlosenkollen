...
const whoIsThisForByLanguage: Record<Language, string[]> = {
  sv: [
    'Retailkedjor',
    'Företag med flera butiker eller kortterminaler',
    'Företag med hög kortomsättning',
    'Företag med en varierad transaktionsmix',
    'Företag som vill minska sina kostnader för kortbetalningar',
    'Företag med internationella kunder',
  ],
  en: [
    'Retail chains',
    'Companies with several stores or card terminals',
    'Companies with high card turnover',
    'Companies with a varied transaction mix',
    'Companies that want to reduce their card payment costs',
    'Companies with international customers',
  ],
  no: [
    'Butikkjeder',
    'Bedrifter med flere butikker eller kortterminaler',
    'Bedrifter med høy kortomsetning',
    'Bedrifter med en variert transaksjonsmiks',
    'Bedrifter som ønsker å redusere kostnadene for kortbetaling',
    'Bedrifter med internasjonale kunder',
  ],
  da: [
    'Detailkæder',
    'Virksomheder med flere butikker eller kortterminaler',
    'Virksomheder med høj kortomsætning',
    'Virksomheder med en varieret transaktionsmix',
    'Virksomheder, der vil reducere deres omkostninger til kortbetaling',
    'Virksomheder med internationale kunder',
  ],
  fi: [
    'Vähittäiskaupan ketjut',
    'Yritykset, joilla on useita myymälöitä tai maksupäätteitä',
    'Yritykset, joilla on suuri korttimyynti',
    'Yritykset, joilla on monipuolinen korttijakauma',
    'Yritykset, jotka haluavat pienentää korttimaksujen kustannuksiaan',
    'Yritykset, joilla on kansainvälisiä asiakkaita',
  ],
}
